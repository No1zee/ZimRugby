...
export default function ArticleCard({
  ...
  return (
    <Link href={href} className="block group">
      <div className="bg-white border border-black/5 rounded-2xl overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="p-5">
          ...
          <span className="inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-wider text-zru-green mt-4 group-hover:gap-2.5 transition-all">
