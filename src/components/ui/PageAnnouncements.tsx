        ...
        return (
          <div 
            ...
            className={`relative w-full rounded-2xl p-5 md:p-6 overflow-hidden backdrop-blur-md border transition-all duration-300 ${
              isCritical
                ? "bg-gradient-to-br from-red-500/10 via-red-500/5 to-transparent border-red-500/20 shadow-[0_4px_25px_rgba(239,68,68,0.06)]"
                : isHigh
                  ? "bg-gradient-to-br from-zru-green/10 via-zru-green/2 to-transparent border-zru-green/20 shadow-[0_4px_20px_rgba(0,107,63,0.05)]"
                    ...
                    {ann.badge && (
                      <span className={`text-[8px] font-black uppercase tracking-widest px-2 py-0.5 rounded-sm border ${
                        isCritical
                          ...
                          : "bg-zru-green/10 text-zru-green border-zru-green/20"
                      }`}>
                        {ann.badge}
                      </span>
                    )}
                    <span className="text-[10px] text-black/50 font-bold uppercase tracking-widest">
                      Union Bulletin
                    </span>
                  </div>
