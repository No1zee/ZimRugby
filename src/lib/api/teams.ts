...
const MOCK_TEAMS: Record<string, Team> = {
    "sables": {
      ...
      squad: [
        ...
        { name: "Cleopas Kundiona", position: "Prop", club: "Nevers (France)", caps: 18, image: "/images/teams/headshots/Cleopas Kundiona.jpg" },
        ...
        { name: "Victor Mupunga", position: "Prop", club: "US Bourg-En-Bresse", caps: 12, image: "/images/teams/headshots/Victor Mupunga.jpg" },
        ...
        { name: "Andrew Tandy", position: "Wing", club: "Old Hararians", caps: 8, image: "/images/teams/headshots/Andrew Tandy.jpg" },
        { name: "David Makamba", position: "Wing", club: "Harare Sports Club", caps: 3, image: "/images/teams/headshots/David Makamba.jpg" },
        { name: "Lynton Nembaware", position: "Utility Back", club: "Harare Sports Club", caps: 4, image: "/images/teams/headshots/Lynton Nembaware.jpg" },
