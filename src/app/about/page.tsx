  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-white/5">
        <div className="bg-white/5 border border-white/5 rounded-2xl p-6 hover:border-zru-gold/20 transition-all">
          <div className="flex items-center gap-3 mb-4">
            <Target className="w-6 h-6 text-zru-gold" />
        ...
        <div className="bg-white/5 border border-white/5 rounded-2xl p-6 hover:border-zru-gold/20 transition-all">
          <div className="flex items-center gap-3 mb-4">
            <Award className="w-6 h-6 text-zru-gold" />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-6 border-t border-white/5 text-center">
        {stats.map((stat) => (
          <div key={stat.label} className="bg-white/5 border border-white/5 rounded-2xl p-4">
            <div className="text-3xl font-black text-zru-gold italic mb-1">{stat.value}</div>
      ...
      <div className="pt-8 border-t border-white/5 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
          <a href="mailto:info@zimbabwerugby.co.zw" className="flex items-center gap-3 text-white/60 hover:text-zru-gold transition-colors font-medium">
            <Mail className="w-5 h-5 text-zru-gold shrink-0" />
            <span>info@zimbabwerugby.co.zw</span>
          </a>
          <div className="flex items-center gap-3 text-white/60 font-medium">
            <MapPin className="w-5 h-5 text-zru-gold shrink-0" />
            <span>National Sports Stadium, Harare</span>
          </div>
          <a href="tel:+263242751234" className="flex items-center gap-3 text-white/60 hover:text-zru-gold transition-colors font-medium">
            <Phone className="w-5 h-5 text-zru-gold shrink-0" />
