  ...
  return (
    <div className="space-y-10">
      ...
      <div className="border-l-4 border-zru-green pl-4">
        <h2 className="text-2xl font-black uppercase tracking-wider text-rich-black">BOARD & LEADERSHIP</h2>
        <p className="text-sm text-rich-black/50 mt-1">Members governing the strategic decisions of the union.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-5 border-t border-black/5">
        {leaders.map((person) => (
          <div key={person.name} className="bg-milk-white border border-black/5 rounded-2xl p-5 text-center group transition-[border-color,box-shadow] hover:border-zru-green/30 hover:shadow-md">
            ...
            <h3 className="font-black text-base text-rich-black uppercase tracking-tight">{person.name}</h3>
            <p className="text-rich-black/60 text-xs font-bold uppercase mt-1 tracking-wider leading-relaxed">{person.role}</p>
            <span className="inline-block bg-zru-green/10 text-zru-green text-[9px] font-black uppercase tracking-widest px-2.5 py-0.5 rounded-full mt-4">
              {person.status}
            </span>
          </div>
        ))}
      ...
      <div className="pt-8 border-t border-black/5">
        <div className="bg-[#004D2C] text-white rounded-3xl p-7 relative overflow-hidden border border-white/10 shadow-lg">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            <div className="w-36 h-36 relative rounded-full overflow-hidden border-4 border-white/20 shadow-xl shrink-0">
              <Image 
            ...
            <div className="space-y-4 max-w-2xl text-center md:text-left">
              <span className="text-emerald-300 text-[9px] font-black uppercase tracking-[0.3em] block">
                IN MEMORIAM & TRIBUTE
              </span>
              <h3 className="text-3xl font-black text-white uppercase tracking-tighter italic leading-none">
                Aaron Jani
              </h3>
              <p className="text-emerald-100 text-sm font-bold italic">
