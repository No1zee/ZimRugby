  ...
  return (
    <div className="space-y-12">
        ...
        {leaders.map((person) => (
          <div key={person.name} className="bg-white/5 border border-white/5 rounded-2xl p-6 text-center group hover:border-white/10 transition-colors">
            <div className="w-16 h-16 bg-zru-green/20 rounded-full flex items-center justify-center mx-auto mb-4 border border-white/5">
              <Users className="w-6 h-6 text-zru-gold" />
            </div>
            ...
            <span className="inline-block bg-zru-green/20 text-zru-gold text-[9px] font-black uppercase tracking-widest px-2.5 py-0.5 rounded-full mt-4">
              {person.status}
            </span>
          </div>
        ))}
      ...
      <div className="pt-10 border-t border-white/5">
        <div className="bg-linear-to-br from-zru-green/30 to-rich-black border border-zru-gold/20 rounded-3xl p-8 relative overflow-hidden">
          <div className="absolute top-4 right-4 text-zru-gold/20">
            <Heart className="w-24 h-24 fill-current" />
          </div>
          
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            <div className="w-36 h-36 relative rounded-full overflow-hidden border-4 border-zru-gold/50 shadow-xl shrink-0">
              <Image 
            ...
            <div className="space-y-4 max-w-2xl text-center md:text-left">
              <span className="text-zru-gold text-[9px] font-black uppercase tracking-[0.3em] block">
                IN MEMORIAM & TRIBUTE
              </span>
